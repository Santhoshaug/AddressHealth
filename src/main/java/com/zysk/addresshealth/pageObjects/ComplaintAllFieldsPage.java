...
public class ComplaintAllFieldsPage extends AbstractComponent{

	WebDriver driver;
	
	public ComplaintAllFieldsPage(WebDriver driver) {
		super(driver);
		this.driver=driver;
...
/*******************Page element identifiers**********************************/
	...
	String studentSearchName="MOHAK NATARAJAN";
	...
	public void advice() {
		for(int i=0;i<adviceLabel.size();i++)                  //2 for abdomen pain
		{
...
//			}
	...
	{
		waitForElementToAppear(complaintSection);
		scroll();
