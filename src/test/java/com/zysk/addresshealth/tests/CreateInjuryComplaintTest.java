...
public class CreateInjuryComplaintTest extends BaseTest{
	...
	public void createComplaint(HashMap<String, String> input) throws Exception {
		...
		try {
			...
			complaintPage.complaintDropdown(6);
			complaintPage.childAccompained();
			complaintPage.locations();
			complaintPage.howItOccured();
			complaintPage.descriptions();
			complaintPage.examinationFindings();
			complaintPage.orientation();
			complaintPage.consciousness();
